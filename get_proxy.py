...
def main():
    ...
    ip_pools_path = today + "_ip_pools.txt"                 # 原始ip保存路径
    ip_format_pools_path =  today + "_ip_format_pools.txt"   # 格式化后ip保存路径
    ip_use_path = today + "_ip_use.txt"                     # 可用ip保存路径

    open_proxy =False  # 是否要开启代理模式
    if not open_proxy:
        # 不开启代理模式，直接获取代理ip
        ...
        # 开启代理模式，获取代理ip
        available_ip_path = "/Users/kid/PycharmProjects/untitled1/test.txt"  # 目前可用的代理ip的保存路径
        ip_use_list = []
